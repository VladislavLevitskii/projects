...
#define list_container_of(ptr, type, member) \
    ({ \
        ...
        (type*)((const unsigned char*)__mptr - list_offset_of(type, member)); \
    })
 ...
 *
 * @param link The item link before the added one.
 *
 */
static inline void list_insert(link_t* prev_link, link_t* new_link) {
